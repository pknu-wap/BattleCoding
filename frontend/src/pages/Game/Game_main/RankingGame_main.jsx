      ...
      <div className="gameMain">
        ...
        <div className="quizIntro">
          ...
          <div className="quizSubText">
            <p>지금 바로 도전해보세요!</p>
            <p>
              당신의 이름을 <strong>랭킹</strong>에 올릴 차례입니다.
            </p>
          </div>
        </div>
        ...
        <div className="ruleSection">
          <h3>랭킹 모드 안내</h3>
          <p>
            <strong>총 10문제</strong>가 출제되며 <strong>모든 유형의 문제</strong>가 무작위로 혼합되어 등장합니다.
          </p>
          <p>
            연습 모드에서는 볼 수 없는 <strong>전용 문제</strong>도 포함됩니다.
          </p>
          <p>
            문제를 맞힐수록 <strong>XP가 증가</strong>하며 더 빠르게 풀수록 <strong>보너스 XP</strong>를 획득할 수
            있습니다.
          </p>
          <p>
            누적된 XP는 <strong>실시간 랭킹</strong>에 즉시 반영되어 상위 랭커에 도전할 수 있는 기회가 됩니다.
          </p>
        </div>
